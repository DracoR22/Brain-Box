...
import Logo from "../../../public/brainbg.png"
  ...
  return (
    <header className="p-4 flex justify-center items-center">
       ...
       {/* NAVIGATION ITEMS */}
           ...
           <NavigationMenuList className="gap-6">
            {/* RESOURCES */}
              <NavigationMenuItem>
                 <NavigationMenuTrigger onClick={() => setPath("#resources")}
                  className={cn({
                    ...
                    'dark:text-white/50': path !== '#resources',
                    'font-normal': true, 'text-base': true})}>
                       Resources
              ...
              <NavigationMenuItem>
                ...
                'dark:text-white/50': path !== '#pricing',
                'font-normal': true,'text-base': true})}>
                   Pricing
               </NavigationMenuTrigger>
               <NavigationMenuContent>
            ...
            {/* TESTIMONIALS */}
          <NavigationMenuItem>
            <NavigationMenuLink className={cn(navigationMenuTriggerStyle(), { 'dark:text-white cursor-pointer': path === '#testimonials',
                'dark:text-white/50': path !== '#testimonials',
                'font-normal': true,
                'text-base': true,
              })}>
              Testimonial
        ...
        <Link href={'/login'}>
          <Button variant="ghost" className="text-base hidden sm:block">
            Login
          </Button>
        </Link>
        <Link href="/signup">
          <Button className="text-base font-semibold hover:bg-indigo-500">
            Sign Up
          </Button>
        </Link>
      </aside>
